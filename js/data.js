...
const GAME_DATA = {
  ...
  levels: [
    ...
    // ===================================================================
    {
      ...
      pertanyaanPemantik: "Bagaimana minyak rem yang encer mampu menghentikan mobil yang melaju kencang?",
      objectives: [
        ...
        components: [
          {
            ...
            image: "assets/komponen_rem/pad_rem.jpg"
          },
          {
            id: "caliper",
          ...
          },
          {
            ...
            image: "assets/komponen_rem/piringan_cakram.jpg"
          },
          {
            id: "master-cylinder",
            ...
            image: "assets/komponen_rem/master_rem.jpg"
          },
          {
            id: "brake-booster",
            ...
            image: "assets/komponen_rem/booster_rem.jpg"
          },
          {
            id: "brake-line",
            ...
            image: "assets/komponen_rem/pipa_selang_rem.jpg"
          },
          {
            id: "wheel-cylinder",
            ...
            image: "assets/komponen_rem/silinder_roda.jpg"
          },
          {
            id: "brake-shoe",
            ...
            image: "assets/komponen_rem/sepatu_rem_tromol.jpg"
          }
        ],
        dropZones: [
    ...
    // ===================================================================
    {
      ...
      pertanyaanPemantik: "Bagaimana sebuah ledakan kecil di dalam mesin silinder mampu menggerakkan mobil?",
      objectives: [
      ...
      simulation: {
        ...
        components: [
          ...
          },
          {
            ...
            image: "assets/komponen_mesin/batang_penghubung.jpg"
          },
          {
            id: "crankshaft",
            ...
            image: "assets/komponen_mesin/poros_engkol.jpg"
          },
          {
            id: "camshaft",
            ...
            image: "assets/komponen_mesin/poros_nok.jpg"
          },
          {
            id: "valve-intake",
            ...
            image: "assets/komponen_mesin/katup_masuk.jpg"
          },
          {
            id: "valve-exhaust",
            ...
            image: "assets/komponen_mesin/katup_buang.jpg"
          },
          {
            id: "cylinder-head",
            ...
            image: "assets/komponen_mesin/kepala_silinder.jpg"
          },
          {
            id: "spark-plug",
    ...
    // ===================================================================
    {
      ...
      pertanyaanPemantik: "Bagaimana aki mobil tetap penuh dayanya meski dipakai terus saat berkendara?",
      objectives: [
      ...
      simulation: {
        ...
        components: [
          ...
          },
          {
            ...
            image: "assets/komponen_kelistrikan/motor_starter.jpg"
          },
          {
            id: "relay",
            name: "Relay",
          ...
          },
          {
            ...
            image: "assets/komponen_kelistrikan/kabel_body_ground.jpg"
          },
          {
            id: "ignition-switch",
            ...
            image: "assets/komponen_kelistrikan/kunci_kontak.jpg"
          },
          {
            id: "headlamp",
            ...
            image: "assets/komponen_kelistrikan/lampu_utama.jpg"
          }
        ],
        dropZones: [
      ...
      quiz: [
        ...
        },
        {
          ...
          correct: 2,
          explanation: "Kabel ground menghubungkan terminal negatif baterai ke bodi atau rangka kendaraan untuk menyediakan jalur kembali arus listrik bagi seluruh komponen kelistrikan kendaraan."
        }
      ]
    },
    {
      id: 4,
      title: "Komponen Otomotif",
      subtitle: "Automotive Components",
      icon: "🔧",
      color: "#8b5cf6",
      description: "Pelajari klasifikasi komponen otomotif berdasarkan fungsinya, mulai dari komponen utama konversi energi, komponen tambahan mesin, hingga komponen perlengkapan mesin otomotif secara mendalam.",
      pertanyaanPemantik: "Bagaimana bagian-bagian kecil seperti katup atau poros engkol bekerja sama untuk mengubah energi bahan bakar menjadi tenaga gerak mobil?",
      objectives: [
        "Mengidentifikasi komponen utama konversi energi otomotif",
        "Memahami fungsi komponen tambahan mesin otomotif",
        "Mengetahui komponen perlengkapan mesin otomotif",
        "Menjelaskan klasifikasi komponen otomotif berdasarkan fungsinya"
      ],
      ...
      learning: [
        {
          title: "Komponen Utama Konversi Energi Otomotif",
          content: "<h3>Komponen Utama Konversi Energi</h3><p>Komponen utama konversi energi otomotif adalah bagian-bagian mesin yang secara langsung terlibat dalam mengubah energi kimia bahan bakar menjadi energi gerak mekanis (putaran).</p><h3>Daftar Komponen Utama</h3><ul><li><strong>Blok Silinder (Cylinder Block)</strong> - Dudukan silinder, piston, crankshaft, dan saluran air pendingin/oli.</li><li><strong>Kepala Silinder (Cylinder Head)</strong> - Dudukan mekanisme katup, busi, dan ruang bakar.</li><li><strong>Piston & Ring Piston</strong> - Piston menerima tekanan pembakaran dan meneruskannya ke crankshaft. Ring piston mencegah kebocoran kompresi dan menyapu oli di dinding silinder.</li><li><strong>Batang Piston (Connecting Rod)</strong> - Menghubungkan piston ke crankshaft and mengubah gerakan linier piston menjadi gerak putar.</li><li><strong>Poros Engkol (Crankshaft)</strong> - Mengubah gerakan naik-turun piston menjadi gerak putar yang menggerakkan roda gila.</li><li><strong>Roda Gila (Flywheel)</strong> - Menyimpan energi putar dan menjaga kelancaran putaran mesin di antara langkah usaha.</li></ul>",
          keyPoints: [
            "Komponen konversi energi secara langsung mengubah energi bahan bakar menjadi gerak.",
            "Blok silinder, kepala silinder, piston, connecting rod, dan crankshaft adalah komponen inti.",
            "Flywheel menjaga kestabilan putaran mesin."
          ]
        },
        {
          title: "Komponen Tambahan Mesin Otomotif",
          content: "<h3>Komponen Tambahan Mesin</h3><p>Komponen tambahan (auxiliary components) berfungsi untuk mendukung kerja mesin agar dapat beroperasi secara optimal, efisien, aman, dan tahan lama.</p><h3>Daftar Komponen Tambahan</h3><ul><li><strong>Camshaft (Poros Nok)</strong> - Membuka dan menutup katup pada waktu yang tepat.</li><li><strong>Mekanisme Katup (Valve Mechanism)</strong> - Terdiri dari katup masuk (intake valve) untuk udara/bahan bakar, dan katup buang (exhaust valve) untuk gas buang.</li><li><strong>Panci Oli (Oil Pan/Bak Oli)</strong> - Menampung oli pelumas mesin, terletak di bagian paling bawah blok mesin.</li><li><strong>Gasket Kepala Silinder</strong> - Kepingan perapat di antara kepala silinder dan blok silinder untuk mencegah kebocoran kompresi, oli, dan air pendingin.</li><li><strong>Timing Belt/Chain</strong> - Menghubungkan crankshaft dan camshaft untuk sinkronisasi pembukaan katup dengan pergerakan piston.</li></ul>",
          keyPoints: [
            "Auxiliary components mendukung kinerja, efisiensi, dan durabilitas mesin.",
            "Camshaft mengontrol pembukaan dan penutupan katup masuk dan buang.",
            "Timing belt/chain mensinkronkan crankshaft dengan camshaft."
          ]
        },
        {
          title: "Komponen Perlengkapan Mesin Otomotif",
          content: "<h3>Komponen Perlengkapan Mesin</h3><p>Komponen perlengkapan (engine accessories/equipments) adalah sistem eksternal atau aksesoris mesin yang melekat pada mesin untuk memproses udara, bahan bakar, pelumasan, dan listrik.</p><h3>Daftar Komponen Perlengkapan</h3><ul><li><strong>Intake Manifold</strong> - Saluran masuk udara (dan bahan bakar pada sistem injeksi port) menuju ruang bakar di kepala silinder.</li><li><strong>Exhaust Manifold</strong> - Saluran pembuangan gas sisa pembakaran dari kepala silinder menuju knalpot.</li><li><strong>Alternator</strong> - Mengubah energi gerak mesin menjadi listrik AC lalu menyearahkannya menjadi DC untuk mengisi baterai dan menyuplai sistem kelistrikan saat mesin hidup.</li><li><strong>Motor Starter</strong> - Memutar crankshaft pertama kali untuk menghidupkan mesin.</li><li><strong>Pompa Air (Water Pump)</strong> - Mensirkulasikan cairan pendingin (coolant) ke seluruh sistem pendingin mesin.</li><li><strong>Filter Udara & Filter Oli</strong> - Menyaring kotoran dari udara masuk dan sirkulasi pelumas mesin agar komponen dalam tetap bersih dan awet.</li></ul>",
          keyPoints: [
            "Komponen perlengkapan memproses udara, bahan bakar, pelumasan, dan kelistrikan luar mesin.",
            "Manifold mengarahkan aliran udara masuk dan gas buang keluar.",
            "Alternator, starter, dan pompa air digerakkan atau mendukung operasi kelistrikan & suhu mesin."
          ]
        }
      ],

      // -----------------------------------------------------------------
      // SIMULATION — Interactive Assembly
      // -----------------------------------------------------------------
      simulation: {
        title: "Kelompokkan Komponen Otomotif",
        instruction: "Seret komponen otomotif ke zona posisinya yang benar pada mesin!",
        components: [
          {
            id: "cylinder-block",
            name: "Blok Silinder",
            description: "Komponen utama konversi energi. Tempat piston bergerak naik-turun dan berisi lubang silinder serta saluran pendingin. Terletak di tengah blok mesin.",
            correctZone: "zone-cylinder-block",
            image: "🧱"
          },
          {
            id: "crankshaft",
            name: "Poros Engkol",
            description: "Komponen utama konversi energi. Mengubah gerak lurus naik-turun piston menjadi gerak putar. Terletak di bagian paling bawah blok mesin.",
            correctZone: "zone-crankshaft",
            image: "⛓️"
          },
          {
            id: "flywheel",
            name: "Roda Gila (Flywheel)",
            description: "Komponen utama konversi energi. Menyimpan energi putar dan menyalurkan tenaga mesin ke sistem pemindah daya. Terpasang di ujung belakang crankshaft.",
            correctZone: "zone-flywheel",
            image: "⚙️"
          },
          {
            id: "camshaft",
            name: "Camshaft (Poros Nok)",
            description: "Komponen tambahan mesin. Memiliki tonjolan (nok) untuk membuka katup pada waktu yang tepat. Terletak di kepala silinder.",
            correctZone: "zone-camshaft",
            image: "🔩"
          },
          {
            id: "head-gasket",
            name: "Gasket Kepala Silinder",
            description: "Komponen tambahan mesin. Berfungsi sebagai perapat untuk mencegah kebocoran gas kompresi, air pendingin, dan oli di antara blok dan kepala silinder.",
            correctZone: "zone-gasket",
            image: "📋"
          },
          {
            id: "intake-manifold",
            name: "Intake Manifold",
            description: "Komponen perlengkapan mesin. Saluran yang mendistribusikan udara (atau campuran bahan bakar-udara) ke setiap silinder. Terletak di sisi masuk kepala silinder.",
          ...
          },
          {
            id: "alternator",
            name: "Alternator",
            description: "Komponen perlengkapan mesin. Generator listrik yang menghasilkan arus AC dan menyearahkannya ke DC untuk menyuplai listrik kendaraan. Terletak di bagian depan mesin.",
            correctZone: "zone-alternator",
            image: "⚡"
          },
          {
            id: "motor-starter",
            name: "Motor Starter",
            description: "Komponen perlengkapan mesin. Mengubah energi listrik baterai menjadi energi mekanis untuk memutar mesin pertama kali. Terletak dekat flywheel.",
            correctZone: "zone-starter",
            image: "🚀"
          }
        ],
        dropZones: [
          { id: "zone-camshaft", label: "Camshaft (Kepala Silinder Atas)", x: 30, y: 33 },
          { id: "zone-gasket", label: "Gasket (Antara Head & Blok)", x: 30, y: 37 },
          { id: "zone-cylinder-block", label: "Blok Silinder (Tengah Mesin)", x: 30, y: 40 },
          { id: "zone-crankshaft", label: "Poros Engkol (Bawah Blok)", x: 30, y: 45 },
          { id: "zone-flywheel", label: "Roda Gila (Belakang Mesin)", x: 38, y: 43 },
          { id: "zone-starter", label: "Motor Starter (Bawah Dekat Flywheel)", x: 35, y: 49 },
          { id: "zone-intake-manifold", label: "Intake Manifold (Saluran Masuk)", x: 23, y: 35 },
          { id: "zone-alternator", label: "Alternator (Bagian Depan)", x: 18, y: 38 }
        ]
      },
      ...
      quiz: [
        {
          id: "q4-1",
          question: "Manakah di bawah ini yang merupakan kelompok komponen utama konversi energi otomotif?",
          image: null,
          options: [
            "Alternator, Motor Starter, Pompa Air",
            "Camshaft, Katup, Bak Oli",
            "Piston, Poros Engkol (Crankshaft), Blok Silinder",
            "Timing Belt, Gasket, Intake Manifold"
          ],
          correct: 2,
          explanation: "Kelompok komponen utama konversi energi secara langsung terlibat dalam mengubah energi pembakaran menjadi energi gerak mekanis. Komponen ini meliputi piston, poros engkol (crankshaft), blok silinder, kepala silinder, dan roda gila (flywheel)."
        },
        {
          id: "q4-2",
          question: "Apa fungsi dari cincin/ring piston pada komponen utama konversi energi otomotif?",
          image: null,
          options: [
            "Membuka dan menutup saluran udara masuk",
            "Mencegah kebocoran gas kompresi dan menyapu oli pelumas di dinding silinder",
            "Menghubungkan piston dengan roda gila secara langsung",
            "Mendinginkan kepala silinder secara langsung"
          ],
          correct: 1,
          explanation: "Ring piston memiliki dua fungsi utama: ring kompresi mencegah kebocoran gas kompresi dari ruang bakar ke bak engkol, sedangkan ring oli menyapu kelebihan oli pelumas pada dinding silinder agar tidak ikut terbakar."
        },
        {
          id: "q4-3",
          question: "Gerakan naik-turun piston diubah menjadi gerak putar oleh komponen utama konversi energi yang disebut...",
          image: null,
          options: [
            "Camshaft",
          ...
          correct: 1,
          explanation: "Poros engkol (crankshaft) bertugas menerima tenaga dorong piston melalui batang piston (connecting rod) dan mengubah gerakan naik-turun (linier) tersebut menjadi gerak putar (rotasi)."
        },
        {
          id: "q4-4",
          question: "Manakah di bawah ini yang termasuk dalam komponen tambahan mesin otomotif?",
          image: null,
          options: [
            "Alternator dan Pompa Air",
            "Blok Silinder dan Piston",
            "Camshaft, Katup, dan Gasket Kepala Silinder",
            "Intake Manifold dan Knalpot"
          ],
          correct: 2,
          explanation: "Komponen tambahan (auxiliary components) mendukung kerja mesin utama agar berjalan lancar, efisien, dan sinkron. Camshaft, mekanisme katup, gasket kepala silinder, panci oli, dan timing belt adalah contoh komponen tambahan."
        },
        {
          id: "q4-5",
          question: "Apa fungsi utama dari Camshaft (poros nok) pada mesin 4 langkah?",
          image: null,
          options: [
            "Mengubah gerak naik-turun piston menjadi gerak putar",
            "Mengatur waktu pembukaan dan penutupan katup masuk dan buang",
            "Menghasilkan percikan bunga api pada busi",
            "Mensirkulasikan air pendingin ke radiator"
          ],
          correct: 1,
          explanation: "Camshaft memiliki tonjolan (nok) yang berputar untuk menekan katup (atau melalui push rod/rocker arm) agar katup masuk dan buang dapat membuka dan menutup pada waktu (timing) yang tepat."
        },
        {
          id: "q4-6",
          question: "Apa yang terjadi jika Gasket Kepala Silinder mengalami kerusakan atau pecah?",
          image: null,
          options: [
            "Arus listrik alternator akan terputus",
            "Katup masuk tidak bisa terbuka lagi",
            "Terjadi kebocoran kompresi, serta percampuran oli dengan cairan pendingin",
            "Motor starter akan macet dan terbakar"
          ],
          correct: 2,
          explanation: "Gasket kepala silinder berfungsi merapatkan blok dan kepala silinder. Jika gasket rusak, gas kompresi bocor (daya mesin turun) dan air pendingin/oli dapat saling bercampur sehingga merusak mesin."
        },
        {
          id: "q4-7",
          question: "Komponen perlengkapan mesin otomotif yang berfungsi menghasilkan energi listrik untuk mengisi baterai saat mesin hidup adalah...",
          image: null,
          options: [
            "Motor Starter",
            "Alternator",
          ...
          correct: 1,
          explanation: "Alternator bertugas menghasilkan arus listrik AC (yang kemudian disearahkan menjadi DC) untuk mensuplai kelistrikan kendaraan dan mengisi daya baterai (aki) selama mesin menyala."
        },
        {
          id: "q4-8",
          question: "Saluran yang membagi dan menyalurkan campuran udara dan bahan bakar ke masing-masing silinder disebut...",
          image: null,
          options: [
            "Exhaust Manifold",
            "Intake Manifold",
          ...
          correct: 1,
          explanation: "Intake manifold adalah saluran masuk udara (dan bahan bakar) eksternal yang melekat pada kepala silinder untuk menyalurkan suplai pembakaran ke masing-masing pintu masuk silinder."
        },
        {
          id: "q4-9",
          question: "Komponen perlengkapan mesin otomotif yang berfungsi memutar poros engkol pertama kali untuk menghidupkan mesin adalah...",
          image: null,
          options: [
            "Alternator",
            "Camshaft",
          ...
          correct: 2,
          explanation: "Motor starter menggunakan arus listrik besar dari baterai untuk menghasilkan gaya putar mekanis yang memutar flywheel dan crankshaft pertama kali agar mesin bisa memulai siklus kerjanya."
        },
        {
          id: "q4-10",
          question: "Di manakah oli pelumas ditampung pada mesin otomotif sebelum disedot oleh pompa oli?",
          image: null,
          options: [
            "Intake Manifold",
            "Kepala Silinder",
            "Bak Oli (Oil Pan / Panci Oli)",
            "Crankshaft Journal"
          ],
          correct: 2,
          explanation: "Bak oli (oil pan/panci oli) adalah komponen tambahan mesin yang terletak di bagian paling bawah mesin untuk menampung oli pelumas sisa sirkulasi sebelum disaring dan dipompa kembali ke bagian atas mesin."
        }
      ]
    },
    ...
    // ===================================================================
    {
      ...
      pertanyaanPemantik: "Mengapa mesin mobil yang bekerja sangat panas tidak meleleh saat digunakan?",
      objectives: [
        ...
        components: [
          {
            ...
            image: "assets/komponen_bbm_pendingin/tangki_bahan_bakar.jpg"
          },
          {
            id: "fuel-pump",
            ...
            image: "assets/komponen_bbm_pendingin/pompa_bahan_bakar.jpg"
          },
          {
            id: "fuel-filter",
            ...
            image: "assets/komponen_bbm_pendingin/filter_bahan_bakar.jpg"
          },
          {
            id: "injector",
          ...
          },
          {
            ...
            image: "assets/komponen_bbm_pendingin/pompa_air_radiator.jpg"
          },
          {
            id: "fan-belt",
            ...
            image: "assets/komponen_bbm_pendingin/drive_belt.jpg"
          }
        ],
        dropZones: [
    ...
    // ===================================================================
    {
      ...
      icon: "🏆",
      color: "#f59e0b",
      description: "Ujian akhir komprehensif yang menguji seluruh pengetahuan dari Level 1 sampai 5. Buktikan kemampuanmu dan raih gelar Master Technician! Soal mencakup semua sistem: rem, mesin, kelistrikan, komponen otomotif, BBM, dan pendingin.",
      pertanyaanPemantik: "Apakah kamu sudah siap menguji keahlian mekanikmu dan memecahkan semua masalah?",
      objectives: [
      ...
      learning: [
        {
          ...
          content: "<h3>6 Sistem Utama yang Telah Dipelajari</h3><ul><li><strong>🔴 Sistem Rem</strong> — menghentikan kendaraan menggunakan gesekan. Komponen: master cylinder, brake booster, kaliper, kampas rem, brake shoe, wheel cylinder, ABS.</li><li><strong>Mesin (Engine)</strong> — mengubah energi BBM menjadi gerak melalui siklus 4 langkah. Komponen: piston, connecting rod, crankshaft, camshaft, valve, cylinder head.</li><li><strong>⚡ Sistem Kelistrikan</strong> — menyediakan listrik untuk semua komponen. Komponen: baterai, alternator, motor starter, sekring, relay, lampu.</li><li><strong>🔧 Komponen Otomotif</strong> — klasifikasi komponen berdasarkan fungsi (utama konversi energi, tambahan, dan perlengkapan mesin).</li><li><strong>⛽ Bahan Bakar</strong> — menyuplai BBM ke mesin. Komponen: tangki, fuel pump, fuel filter, injector, ECU.</li><li><strong>🌡️ Sistem Pendingin</strong> — menjaga suhu mesin optimal. Komponen: radiator, thermostat, water pump, coolant, kipas.</li></ul><p><em>Setiap sistem saling terhubung dan bekerja sama agar kendaraan berjalan dengan aman, nyaman, dan efisien.</em></p>",
          keyPoints: [
      ...
      quiz: [
        ...
        // --- Komponen Otomotif (4 soal) ---
        {
          id: "q6-13",
          question: "Di bawah ini yang merupakan kelompok komponen utama konversi energi pada mesin otomotif adalah...",
          image: null,
          options: [
            "Alternator, Baterai, dan Motor Starter",
            "Camshaft, Katup, dan Timing Chain",
            "Piston, Connecting Rod, dan Crankshaft",
            "Intake Manifold, Exhaust Manifold, dan Air Filter"
          ],
          correct: 2,
          explanation: "Komponen utama konversi energi otomotif secara langsung mengubah energi kimia bahan bakar menjadi energi gerak mekanik. Komponen ini meliputi piston, connecting rod, crankshaft, blok silinder, kepala silinder, dan roda gila (flywheel)."
        },
        {
          id: "q6-14",
          question: "Komponen tambahan mesin yang berfungsi untuk merapatkan celah antara blok silinder dan kepala silinder agar tidak terjadi kebocoran gas kompresi, oli, maupun air pendingin adalah...",
          image: null,
          options: [
            "Panci Oli (Oil Pan)",
          ...
          correct: 1,
          explanation: "Gasket kepala silinder adalah komponen perapat (seal/packing) tambahan mesin yang dipasang di antara blok silinder dan kepala silinder untuk menahan tekanan kompresi tinggi serta mencegah kebocoran sirkulasi oli dan cairan pendingin."
        },
        {
          id: "q6-15",
          question: "Komponen perlengkapan mesin otomotif yang berfungsi menghasilkan arus listrik untuk menyuplai kebutuhan listrik kendaraan dan mengisi baterai saat mesin hidup adalah...",
          image: null,
          options: [
            "Motor Starter",
            "Baterai (Aki)",
          ...
          correct: 2,
          explanation: "Alternator adalah komponen perlengkapan mesin (engine accessory) yang menghasilkan energi listrik saat mesin hidup untuk menyuplai kebutuhan daya listrik kendaraan dan mengisi ulang baterai."
        },
        {
          id: "q6-16",
          question: "Manakah dari pernyataan berikut yang paling tepat mengenai perbedaan antara komponen utama konversi energi dan komponen tambahan mesin?",
          image: null,
          options: [
            "Komponen utama menghasilkan tenaga listrik, sedangkan komponen tambahan memutar roda gila.",
            "Komponen utama langsung mengubah energi pembakaran menjadi gerak putar, sedangkan komponen tambahan menyinkronkan atau mendukung jalannya mekanisme kerja mesin.",
            "Komponen utama berada di luar mesin, sedangkan komponen tambahan berada di dalam ruang bakar.",
            "Komponen utama hanya ada pada kendaraan listrik, sedangkan komponen tambahan ada pada mesin diesel."
          ],
          correct: 1,
          explanation: "Komponen utama konversi energi (seperti piston dan poros engkol) terlibat langsung dalam proses pengubahan energi pembakaran menjadi gerak mekanis. Komponen tambahan (seperti poros nok/camshaft dan mekanisme katup) mendukung serta menyinkronkan jalannya proses kerja tersebut."
        },
  ...
  achievements: [
    ...
    {
      id: "components-beginner",
      title: "Pemula Komponen Otomotif",
      description: "Selesaikan Level 4 — Komponen Otomotif",
      icon: "🔧",
    ...
    },
    {
      ...
      title: "Ahli Komponen Otomotif",
      description: "Raih 3 bintang pada Level 4 — Komponen Otomotif",
      icon: "⭐",
